...
|  nav_mod_failsafe_in_waypoint_mode  | 0 | If set to 0 (default): feature is disabled; If set to 1: failsafe won't enable if RX fails while in waypoint mode (mission continues);  If set to 2: triggers RTH |
